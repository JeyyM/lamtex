...
const ORDER_FULFILLMENT: OrderFulfillment[] = [
  ...
  { id: 'of2', orderNumber: 'ORD-2026-1235', customer: 'BuildMart Cebu', requiredDate: '2026-02-27', productsSummary: '5 items, 1850 kg', stockStatus: 'Partial', fulfillmentStatus: 'Loading', loadingDetails: [{ productName: 'PVC Pipe 2"', qty: 200, status: 'Loading' }, { productName: 'Paint White', qty: 50, status: 'Pending' }], urgency: 'Medium', branch: 'Branch A' },
  ...
  { id: 'of7', orderNumber: 'ORD-2026-1241', customer: 'Island Hardware', requiredDate: '2026-02-28', productsSummary: '4 items, 1650 kg', stockStatus: 'Partial', fulfillmentStatus: 'Loading', loadingDetails: [{ productName: 'PVC Pipe 2"', qty: 120, status: 'Loading' }], urgency: 'Medium', branch: 'Branch B' },
