...
const TRIPS: Trip[] = [
  ...
  // Feb 26
  { id: 'trip8', tripNumber: 'TRIP-2026-A-008', vehicleId: 'TRK-001', vehicleName: 'Truck 001', driverName: 'Juan Santos', status: 'Planned', scheduledDate: '2026-02-26', departureTime: '07:00', destinations: ['Manila', 'Quezon City'], orders: ['ORD-2026-1260'], capacityUsed: 70, weightUsed: 3000, volumeUsed: 16.0, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  { id: 'trip9', tripNumber: 'TRIP-2026-A-009', vehicleId: 'TRK-002', vehicleName: 'Truck 002', driverName: 'Carlos Garcia', status: 'Planned', scheduledDate: '2026-02-26', departureTime: '08:30', destinations: ['Makati City'], orders: ['ORD-2026-1261'], capacityUsed: 55, weightUsed: 2400, volumeUsed: 12.5, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  { id: 'trip10', tripNumber: 'TRIP-2026-A-010', vehicleId: 'TRK-005', vehicleName: 'Truck 005', driverName: 'Roberto Reyes', status: 'Planned', scheduledDate: '2026-02-26', departureTime: '10:00', destinations: ['Pasig City', 'Mandaluyong'], orders: ['ORD-2026-1262', 'ORD-2026-1263'], capacityUsed: 80, weightUsed: 3800, volumeUsed: 20.0, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  { id: 'trip11', tripNumber: 'TRIP-2026-A-011', vehicleId: 'TRK-006', vehicleName: 'Truck 006', driverName: 'Fernando Lopez', status: 'Planned', scheduledDate: '2026-02-26', departureTime: '13:00', destinations: ['Caloocan', 'Valenzuela'], orders: ['ORD-2026-1264'], capacityUsed: 45, weightUsed: 2200, volumeUsed: 11.0, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  
  // Feb 27
  { id: 'trip12', tripNumber: 'TRIP-2026-A-012', vehicleId: 'TRK-003', vehicleName: 'Truck 003', driverName: 'Pedro Cruz', status: 'Planned', scheduledDate: '2026-02-27', departureTime: '06:30', destinations: ['Quezon City'], orders: ['ORD-2026-1265'], capacityUsed: 60, weightUsed: 2800, volumeUsed: 14.5, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  { id: 'trip13', tripNumber: 'TRIP-2026-A-013', vehicleId: 'TRK-004', vehicleName: 'Truck 004', driverName: 'Miguel Torres', status: 'Planned', scheduledDate: '2026-02-27', departureTime: '09:00', destinations: ['Manila'], orders: ['ORD-2026-1266'], capacityUsed: 50, weightUsed: 2500, volumeUsed: 13.0, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  { id: 'trip14', tripNumber: 'TRIP-2026-A-014', vehicleId: 'TRK-007', vehicleName: 'Truck 007', driverName: 'Jose Martinez', status: 'Planned', scheduledDate: '2026-02-27', departureTime: '11:00', destinations: ['Taguig City'], orders: ['ORD-2026-1267'], capacityUsed: 65, weightUsed: 3100, volumeUsed: 16.5, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  
  // Feb 28
  { id: 'trip15', tripNumber: 'TRIP-2026-A-015', vehicleId: 'TRK-001', vehicleName: 'Truck 001', driverName: 'Juan Santos', status: 'Planned', scheduledDate: '2026-02-28', departureTime: '07:30', destinations: ['Pasay City', 'Parañaque'], orders: ['ORD-2026-1268', 'ORD-2026-1269'], capacityUsed: 75, weightUsed: 3400, volumeUsed: 18.0, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  { id: 'trip16', tripNumber: 'TRIP-2026-A-016', vehicleId: 'TRK-008', vehicleName: 'Truck 008', driverName: 'Ricardo Diaz', status: 'Planned', scheduledDate: '2026-02-28', departureTime: '10:30', destinations: ['Las Piñas'], orders: ['ORD-2026-1270'], capacityUsed: 40, weightUsed: 2000, volumeUsed: 10.5, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  
  // March 1
  { id: 'trip17', tripNumber: 'TRIP-2026-A-017', vehicleId: 'TRK-002', vehicleName: 'Truck 002', driverName: 'Carlos Garcia', status: 'Planned', scheduledDate: '2026-03-01', departureTime: '08:00', destinations: ['Makati City', 'BGC'], orders: ['ORD-2026-1271'], capacityUsed: 68, weightUsed: 3200, volumeUsed: 17.0, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  { id: 'trip18', tripNumber: 'TRIP-2026-A-018', vehicleId: 'TRK-005', vehicleName: 'Truck 005', driverName: 'Roberto Reyes', status: 'Planned', scheduledDate: '2026-03-01', departureTime: '12:00', destinations: ['Muntinlupa'], orders: ['ORD-2026-1272'], capacityUsed: 52, weightUsed: 2600, volumeUsed: 13.5, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  
  // March 2
  { id: 'trip19', tripNumber: 'TRIP-2026-A-019', vehicleId: 'TRK-003', vehicleName: 'Truck 003', driverName: 'Pedro Cruz', status: 'Planned', scheduledDate: '2026-03-02', departureTime: '07:00', destinations: ['Quezon City', 'Marikina'], orders: ['ORD-2026-1273', 'ORD-2026-1274'], capacityUsed: 78, weightUsed: 3650, volumeUsed: 19.5, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  { id: 'trip20', tripNumber: 'TRIP-2026-A-020', vehicleId: 'TRK-006', vehicleName: 'Truck 006', driverName: 'Fernando Lopez', status: 'Planned', scheduledDate: '2026-03-02', departureTime: '09:30', destinations: ['San Juan'], orders: ['ORD-2026-1275'], capacityUsed: 48, weightUsed: 2300, volumeUsed: 12.0, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  { id: 'trip21', tripNumber: 'TRIP-2026-A-021', vehicleId: 'TRK-009', vehicleName: 'Truck 009', driverName: 'Antonio Ramirez', status: 'Planned', scheduledDate: '2026-03-02', departureTime: '13:00', destinations: ['Malabon', 'Navotas'], orders: ['ORD-2026-1276'], capacityUsed: 62, weightUsed: 2900, volumeUsed: 15.0, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  ...
  { id: 'trip24', tripNumber: 'TRIP-2026-A-024', vehicleId: 'TRK-004', vehicleName: 'Truck 004', driverName: 'Miguel Torres', status: 'Planned', scheduledDate: '2026-03-04', departureTime: '11:30', destinations: ['Pasig City', 'Taguig'], orders: ['ORD-2026-1279', 'ORD-2026-1280'], capacityUsed: 82, weightUsed: 3900, volumeUsed: 20.5, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  { id: 'trip25', tripNumber: 'TRIP-2026-A-025', vehicleId: 'TRK-007', vehicleName: 'Truck 007', driverName: 'Jose Martinez', status: 'Planned', scheduledDate: '2026-03-04', departureTime: '14:00', destinations: ['Caloocan'], orders: ['ORD-2026-1281'], capacityUsed: 44, weightUsed: 2100, volumeUsed: 11.5, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  
  // March 5 (3 trips)
  { id: 'trip26', tripNumber: 'TRIP-2026-A-026', vehicleId: 'TRK-003', vehicleName: 'Truck 003', driverName: 'Pedro Cruz', status: 'Planned', scheduledDate: '2026-03-05', departureTime: '07:00', destinations: ['Quezon City'], orders: ['ORD-2026-1282'], capacityUsed: 56, weightUsed: 2650, volumeUsed: 13.8, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  { id: 'trip27', tripNumber: 'TRIP-2026-A-027', vehicleId: 'TRK-005', vehicleName: 'Truck 005', driverName: 'Roberto Reyes', status: 'Planned', scheduledDate: '2026-03-05', departureTime: '10:00', destinations: ['Parañaque', 'Las Piñas'], orders: ['ORD-2026-1283'], capacityUsed: 66, weightUsed: 3050, volumeUsed: 16.2, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  { id: 'trip28', tripNumber: 'TRIP-2026-A-028', vehicleId: 'TRK-008', vehicleName: 'Truck 008', driverName: 'Ricardo Diaz', status: 'Planned', scheduledDate: '2026-03-05', departureTime: '13:30', destinations: ['Manila'], orders: ['ORD-2026-1284'], capacityUsed: 50, weightUsed: 2400, volumeUsed: 12.8, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  
  // March 6 (2 trips)
  { id: 'trip29', tripNumber: 'TRIP-2026-A-029', vehicleId: 'TRK-006', vehicleName: 'Truck 006', driverName: 'Fernando Lopez', status: 'Planned', scheduledDate: '2026-03-06', departureTime: '08:00', destinations: ['Mandaluyong', 'San Juan'], orders: ['ORD-2026-1285'], capacityUsed: 62, weightUsed: 2850, volumeUsed: 15.0, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
  { id: 'trip30', tripNumber: 'TRIP-2026-A-030', vehicleId: 'TRK-009', vehicleName: 'Truck 009', driverName: 'Antonio Ramirez', status: 'Planned', scheduledDate: '2026-03-06', departureTime: '11:00', destinations: ['Taguig City'], orders: ['ORD-2026-1286'], capacityUsed: 70, weightUsed: 3200, volumeUsed: 17.0, maxWeight: 5000, maxVolume: 25, branch: 'Branch A' },
