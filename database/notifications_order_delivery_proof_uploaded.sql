-- Notify the assigned agent when delivery proof is uploaded (unless the agent uploaded it).
-- Run in Supabase SQL editor after notifications_order_delivery_recorded.sql.
