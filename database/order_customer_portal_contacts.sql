-- Re-run if customer order summary is missing agent/driver contacts.
-- Replaces get_public_order_summary (agent phone/email + assigned driver).

-- Expands per-line discounts_breakdown into [{ name, percentage?, amount }] for the customer portal.
