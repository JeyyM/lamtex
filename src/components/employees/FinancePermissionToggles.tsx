...
import { toggleFinancePermission } from '@/src/lib/permissions/employeeFinancePermissions';



const PERMISSION_ICONS: Record<FinancePermissionKey, LucideIcon> = {
  pageAccess: Eye,
  commissions: Award,
};
...
export function FinancePermissionToggleGrid({
  ...
  value: FinancePermissionSet;

  onChange: (next: FinancePermissionSet) => void;
      ...
      {FINANCE_PERMISSIONS.map((def) => {
        ...
        return (
          ...
          <button
            ...
            onClick={() => onChange(toggleFinancePermission(value, def.key))}
...
export function FinancePermissionSection({

  title = 'Finance',

  description = 'Control access to the Finance page, commission KPIs, and Commission Release.',
  ...
  savedValue: FinancePermissionSet;
      ...
      <div className="p-4 sm:p-6">
        ...
        {loading ? (
          ...
          <>
            ...
            <FinancePermissionToggleGrid value={value} onChange={onChange} disabled={saving} />
